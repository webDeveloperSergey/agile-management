...
export type ColumnWhereInput = {
  ...
  column_id?: Prisma.UuidFilter<"Column"> | string
  ...
  board_id?: Prisma.UuidFilter<"Column"> | string
...
export type ColumnScalarWhereWithAggregatesInput = {
  ...
  column_id?: Prisma.UuidWithAggregatesFilter<"Column"> | string
  ...
  board_id?: Prisma.UuidWithAggregatesFilter<"Column"> | string
}
...
export type ColumnOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"column_id" | "name" | "order" | "createdAt" | "updatedAt" | "board_id", ExtArgs["result"]["column"]>
...
export interface ColumnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const columnWithColumn_idOnly = await prisma.column.findMany({ select: { column_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Columns and only return the `column_id`
   * const columnWithColumn_idOnly = await prisma.column.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Columns and only return the `column_id`
   * const columnWithColumn_idOnly = await prisma.column.updateManyAndReturn({
   *   select: { column_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ColumnFieldRefs {
  readonly column_id: Prisma.FieldRef<"Column", 'String'>
  ...
  readonly board_id: Prisma.FieldRef<"Column", 'String'>
}
